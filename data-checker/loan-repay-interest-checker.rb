...
if(repay[:amount_interest] != repay[:amount_interest0] + repay[:amount_interest1])
  puts "the interest1 is wrong"
end


if (repay[:amount_interest0] != repay[:company_interest] + repay[:plantform_subsidy_interest] + repay[:plantform_activity_interest])
  puts " the amount interest0  is wrong"
end


if (result[:sum_company_interest] != repay[:company_interest])
  puts "the company interest is wrong"
end


if (result[:sum_plantform_subsidy_interest] != repay[:plantform_subsidy_interest])
  puts "the subsidy interest is wrong "
end


if (result[:sum_plantform_activity_interest] != repay[:plantform_activity_interest])
  puts "the activity interest is wrong"
end
